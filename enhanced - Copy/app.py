...
def init_db():
    ...
    cursor.execute('''
        ...
        ('Trust Your Intuition', 'If something feels wrong, it probably is. Don\'t ignore your gut feelings. Your safety is more important than being polite. Leave immediately if you feel unsafe.', 'emergency'),
        ...
        ('Trust But Verify', 'When meeting someone from online or new contacts, meet in public places. Tell a friend where you\'re going and when you\'ll be back.', 'safety'),
        
        -- Digital Safety
        ('Protect Your Digital Privacy', 'Don\'t share your phone number or address with strangers online. Keep your social media accounts private and limit personal information.', 'technology'),
        ('Secure Your Phone', 'Use strong passwords or biometrics to lock your phone. Enable Find My Device feature. Keep your phone charged when traveling.', 'technology'),
        
        -- Self Defense & Tools
        ('Use the Fake Call Feature', 'If you feel unsafe, use the fake call feature to create an excuse to leave a situation quickly. It\'s a discreet way to extract yourself from danger.', 'safety'),
        ...
        -- Workplace Safety
        ('Workplace Security', 'Be aware of emergency exits at work. Don\'t share sensitive information with colleagues you don\'t trust well. Report any suspicious behavior.', 'safety'),
        ...
        -- Self Care & Awareness
        ('Trust But Verify Online', 'Be cautious about online relationships. Video chat before meeting in person. Search people\'s names and photos to verify their identity.', 'technology'),
